...
| :---- | :---- | :---- |:-------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Pre-training | ShapeNet | [pretrain.yaml](./cfgs/pretrain.yaml) | N.A.   | [ckpt](https://github.com/LMD0311/PointMamba/releases/download/ckpts-2/pretrain.pth) / [log](https://github.com/LMD0311/PointMamba/releases/download/ckpts-2/pretrain.log)                       |
